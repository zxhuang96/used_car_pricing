...
whole_model_prediction_is = pd.read_csv(f'{file_folder}/output/cat/IS_prediction_cat_10,50.csv')
whole_model_prediction_os = pd.read_csv(f'{file_folder}/output/cat/OS_prediction_cat_10,50.csv')
...
print("Writing files...")
out_cat.to_csv(f'{file_folder}/output/OS_prediction_cat_split_'+split_col+'_final2.csv', index=False)
is_cat.to_csv(f'{file_folder}/output/IS_prediction_cat_split_'+split_col+'_final2.csv', index=False)

...
print("Writing files...")
out_lgb.to_csv(f'{file_folder}/output/OS_prediction_lgb_split_'+split_col+'final.csv', index=False)
is_lgb.to_csv(f'{file_folder}/output/IS_prediction_lgb_split_'+split_col+'final.csv', index=False)
